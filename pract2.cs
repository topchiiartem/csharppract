...
// Умова:
// На потоці є кілька груп (3-5). Кожна підгрупа містить від 10 до 30 студентів. Оцінки студентів задані у вигляді зубчастого масиву int[][], де кожен елемент — це масив оцінок однієї підгрупи.

// Завдання
// Для кожної групи та для потоку знайти :
// середній бал,
// мінімальну оцінку,
// максимальну оцінку.
namespace PZ
